...
```
~/.openclaw/                      
鈹溾攢鈹€ workspace/                   # Working directory
鈹?  鈹溾攢鈹€ AGENTS.md               # Multi-agent coordination patterns
鈹?  鈹溾攢鈹€ SOUL.md                 # Behavioral guidelines and personality
鈹?  鈹溾攢鈹€ TOOLS.md                # Tool capabilities and gotchas
鈹?  鈹溾攢鈹€ MEMORY.md               # Long-term memory (main session only)
鈹?  鈹斺攢鈹€ memory/                 # Daily memory files
鈹?      鈹斺攢鈹€ YYYY-MM-DD.md
鈹溾攢鈹€ skills/                      # Installed skills
鈹?  鈹斺攢鈹€ <skill-name>/
鈹?      鈹斺攢鈹€ SKILL.md
鈹斺攢鈹€ hooks/                       # Custom hooks
    鈹斺攢鈹€ <hook-name>/
        鈹溾攢鈹€ HOOK.md
        鈹斺攢鈹€ handler.ts
```
...
鈹溾攢鈹€ Yes 鈫?Keep in .learnings/
鈹斺攢鈹€ No 鈫?Is it behavioral/style-related?
    鈹溾攢鈹€ Yes 鈫?Promote to SOUL.md
    鈹斺攢鈹€ No 鈫?Is it tool-related?
        鈹溾攢鈹€ Yes 鈫?Promote to TOOLS.md
        鈹斺攢鈹€ No 鈫?Promote to AGENTS.md (workflow)
```
